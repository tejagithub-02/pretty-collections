...
const AboutUs = () => {
  useEffect(() => {
    document.title = "About Pretty Collections | Ethnic Fashion Boutique";
  }, []);
      ...
      <section className="intro-section">
        <div className="intro-content">
          ...
          <p className="intro-text">
            Welcome to <strong>Pretty Collections</strong> – your one-stop destination for elegant ethnic fashion.
